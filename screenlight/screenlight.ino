...
const char *client_id = "screenlight"; // Must be unique on the MQTT network

// Topics
const char *light_state_topic = "home/screenlight";
const char *light_set_topic = "home/screenlight/set";
...
{
    analogWrite(RED_PIN, inR);
    analogWrite(GREEN_PIN, inG);
    analogWrite(BLUE_PIN, inB);
